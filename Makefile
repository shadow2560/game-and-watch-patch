...
GNWMANAGER=$(GNWMANAGER_PATH) --verbosity debug -b pyocd
else
GNWMANAGER= gnwmanager --verbosity debug -b pyocd
endif
else
ifeq ($(GNWMANAGER_PATH),)
GNWMANAGER = gnwmanager --verbosity debug
else
GNWMANAGER = $(GNWMANAGER_PATH) --verbosity debug
endif
endif
PYTHON ?= python3
